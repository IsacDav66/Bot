// Ejemplo de cómo los usarías en tu código:
const color = {
...
console.log(`Texto ${color.red}rojo${color.reset} y texto ${color.bgGreen}${color.white}blanco sobre verde${color.reset}.`);
console.log(`${color.bold}${color.cyan}Texto cian en negrita${color.reset}`);
console.log(`${color.brightYellow}Texto amarillo brillante${color.reset}`);
console.log(`${color.bgBlue}${color.white}Texto blanco sobre azul${color.reset}`);
console.log(`${color.magenta}$Texto Magenta{')  ${color.reset}`);